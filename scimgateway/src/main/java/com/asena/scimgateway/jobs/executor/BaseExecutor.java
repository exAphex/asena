...
public class BaseExecutor {
	...
	protected String expandStr(String str, Map<String, String> object) {
	...
	protected void writeData(List<Map<String, String>> data, Pass p) {
	...
	protected List<Map<String, String>> processData(Pass pass, List<Map<String, String>> data) {
